...
<div class="centered-div text-null inline-flex">
	<div
		id="login-form"
		class="card w-96 custom-glass text-white shadow-xl drop-shadow-2xl border-t-slate-100 border-t border-l border-l-slate-100 border-opacity-20 inline-flex"
	>
...
<Alert type="error" msg="Invalid username or password" />
